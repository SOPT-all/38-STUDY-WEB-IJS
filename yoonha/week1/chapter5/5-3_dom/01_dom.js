...
document
  ...
  .setAttribute("data-id", "test_data");
...
// 미리 css에서 작성했던 속성의 값을 보라로 나타나도록 속성 할당
// innerText로 텍스트 노드 삽입
//querySelector로 클래스 선택자 를 선택해 append를 통해 요소를 삽입
...
// appendChild - div 요소 생성해서 appendChild
...
document
  .getElementsByClassName("remove_attribute")[0]
